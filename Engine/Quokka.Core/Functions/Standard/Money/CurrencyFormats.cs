...
namespace Mindbox.Quokka
{
	internal static class CurrencyFormats
	{
		...
		private static readonly IReadOnlyDictionary<string, CurrencyFormat> formatsByCode =
			...
			{
				["AED"] = new("AED", "AED", 2),
				["ARS"] = new("$", "ARS", 2, DotGroup, spaceAfterSymbol: true),
				["AUD"] = new("$", "A$", 2),
				["BHD"] = new("BHD", "BHD", 3),
				["BRL"] = new("R$", "R$", 2, DotGroup, spaceAfterSymbol: true),
				["CAD"] = new("$", "CA$", 2),
				["CHF"] = new("CHF", "CHF", 2, Apostrophe),
				["CLP"] = new("$", "CLP", 0, DotGroup),
				["CNY"] = new("¥", "CN¥", 2),
				["COP"] = new("$", "COP", 0, DotGroup, spaceAfterSymbol: true),
				...
				["ILS"] = new("₪", "₪", 2, symbolFollowsAmount: true),
				["INR"] = new("₹", "₹", 2, Indian),
