...
{
	internal abstract class VariantValueExpression : ExpressionBase
	{
		/// <summary>
		...
		/// </summary>
		public abstract void RegisterIterationOverExpressionResult(SemanticAnalysisContext context, VariableDefinition iterationVariable);
